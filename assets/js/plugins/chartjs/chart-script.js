...
var data = {
	labels : ["Proj Guide","Elec","Emb sys","Sens","Gen prog","Aur prog","PCB","others"],
	datasets : [
		{
			label: "First dataset",
			fillColor : "rgba(103, 58, 183,0.5)",
			strokeColor : "#ffffff",
			pointColor : "rgb(140, 99, 207)",
			pointStrokeColor : "#ffffff",
			pointHighlightFill : "#ffffff",
			pointHighlightStroke : "#ffffff",
			data: [100, 50, 20, 40, 80, 50, 80,20]
		},
		{
			label: "Second dataset",
			fillColor : "rgba(149, 117, 205,0.5)",
			strokeColor : "rgba(103, 58, 183,0.2)",
			pointColor : "rgb(78, 42, 137)",
			pointStrokeColor : "rgba(103, 58, 183,0.8)",
			pointHighlightFill : "rgba(103, 58, 183,0.3)",
			pointHighlightStroke : "rgba(103, 58, 183,0.5)",
			data: [60, 20, 90, 80, 50, 85, 40,60]
		}
	]
};
